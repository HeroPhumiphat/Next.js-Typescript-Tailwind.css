        ...
        <div>
            ...
            <main className='w-full px-5 py-5'>
                ...
                <div className='flex justify-center mt-7'>
                    <div className='grid grid-cols-2 min-[520px]:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-x-8 gap-y-7 justify-items-center items-center'>
                    {
                        products
                            ...
                            .map((product) => (
                                <Link href={'/products/' + product.id} key={product.id}>
                                    <div className='h-auto py-2'>
                                        <div className='text-center border mx-1 md:w-[210px] h-[180px] rounded-md cursor-pointer' style={{boxShadow: '0 0 5px #aaa, 0 0 8px #e3e3e3', backgroundImage: `url(${product.thumbnail})`, backgroundPosition: 'center', backgroundSize: 'cover'}}>
                                        </div>
